...
public class GameCenter implements Initializable {
    ...
    @FXML
    private ImageView imgv_chicken,imgv_turkey,imgv_buffalo,imgv_cat, imgv_dog;

    ArrayList<ImageView> img_chickens = new ArrayList<>();
    ArrayList<ImageView> img_turkies = new ArrayList<>();
    ArrayList<ImageView> img_buffalos = new ArrayList<>();
    ArrayList<ImageView> img_cats = new ArrayList<>();
    ArrayList<ImageView> img_dogs = new ArrayList<>();
    ...
    public void buyChicken() throws IOException{
        ...
        if (coins >= dome.getPrice()) {
            ...
            chickens.add(dome);
            imgv_chicken.setImage(img_chicken);
            imgv_chicken.setLayoutX(appoint_pos_x(dome.getPlace()[0])-36.0);
            imgv_chicken.setLayoutY(appoint_pos_y(dome.getPlace()[1])-36.0);
